...
*Please following standard is only for developers to implement the API. MCVT modelers can use above already implemented API in different programming languages, more detail usages can be found in the user manual [/doc/RETHi_Communication_Network_Guide.pdf](doc/RETHi_Communication_Network_Guide.pdf)*
