classdef Structure_simu_FDD_damage < matlab.System & matlab.system.mixin.Propagates
...
%             obj.K = kron(ones(1,obj.num), obj.Ksingle);
        ...
        function [xe]= stepImpl(obj,xtrue,EnableReset)
            if EnableReset
                ...
                xe = min(max(1 ./ (1 + exp(-obj.xfake_inv_sig(1:2:end) )) + normrnd(0, obj.noise,[obj.num,1]), 0), 1) ;
            else
        ...
        function[i1, i2] = getInputSizeImpl(obj)
            i1 = obj.num;            
            i2 = 1;
        end
